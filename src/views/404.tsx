  ...
  return (
    <Layout title={t(lang, 'notFound.title')} lang={lang} currentPath="/">
      <div class="flex flex-col items-center justify-center py-24">
        ...
        <a href={langPath('/', lang)} class="mt-6 text-xs font-bold uppercase tracking-widest border border-black px-6 py-3 hover:bg-black hover:text-white transition-all no-underline">{t(lang, 'notFound.backHome')}</a>
      </div>
    </Layout>
  )
}
