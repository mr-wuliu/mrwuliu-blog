...
const Layout: FC<LayoutProps> = ({ title, description, url, image, type = 'website', authorProfile, children }) => {
    ...
    <html lang="zh-CN">
      ...
      <body class="font-sans text-base leading-relaxed text-black bg-white antialiased min-h-screen flex flex-col">
        ...
        <footer class="border-t border-black bg-white mt-auto">
          <p class="max-w-6xl mx-auto px-4 md:px-8 lg:px-12 py-8 text-xs font-bold uppercase tracking-widest opacity-50 text-center">&copy; {new Date().getFullYear()} Blog. Powered by Cloudflare Workers.</p>
        </footer>
      </body>
    </html>
  )
